...
- Release-workflow actions are pinned to full commit SHAs because the workflow holds release write and OIDC permissions. Keep the adjacent version comments current when updating those pins.
